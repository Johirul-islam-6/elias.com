          ...
          >
            ...
            <div className="story-body flex flex-col md:gap-x-[40px] justify-center items-center px-2">
              <div className="story-img  md:w-[100%] h-[350px] flex items-start justify-center  ">
                <div className=" p-5 bg-[rgba(158, 112, 255, 0.05)] rounded-[10px] pb-5 lg:mt-10  ">
                  <Image
                    width={200}
                    height={120}
                    src={item?.image}
                  ...
                  />
                  <p className="text-[25px] text-[#969393]  ">{item?.name}</p>
                  <p className="text-[14px] text-[#969393]  pt-1">
                    {item?.datetitle}
                  </p>
                </div>
              </div>
              <div className="flex items-start justify-center  ">
                <div className="story-contain md:w-[100%]">
